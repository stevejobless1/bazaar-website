...
const Home = ({ products, loading, error }: { products: ProductState[], loading: boolean, error: string | null }) => {
  ...
  // ⚡ Bolt Optimization: Memoize the mapping computation to avoid O(N) recalculations on every render.
  ...
  // ⚡ Bolt Optimization: Memoize the array sort to avoid O(N log N) recalculations on every render.
